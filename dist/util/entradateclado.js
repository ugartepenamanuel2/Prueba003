...
var readlineI;
var leelinea = function (prompt) {
    readlineI = readline_1.default.createInterface({
        input: process.stdin,
        output: process.stdout,
    });
    return new Promise(function (resuelta, rechazada) {
        readlineI.question(prompt + ": ", function (cadenaEntrada) {
            resuelta(cadenaEntrada);
        });
    });
};
var leerTeclado = function (prompt) { return __awaiter(void 0, void 0, void 0, function () {
    var valor;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, leelinea(prompt)];
            case 1:
                valor = _a.sent();
                readlineI.close();
